...
urlpatterns = patterns('',
    ...
    url(r'^brew_workers[/]$', 'brew_session.views.brew_workers', name='workers'),
    ...
    url(r'^send_brew_master_command/$', 'brew_session.views.send_brew_master_command'),
    url(r'^send_brew_worker_command/$', 'brew_session.views.send_brew_worker_command'),
